package com.balanced.common.seed;
...
import com.balanced.budget.dto.CreateBudgetInput;
...
import com.balanced.budget.service.BudgetService;
import com.balanced.budget.service.BudgetConfigService;
...
import com.balanced.recurring.dto.CreateRecurringItemInput;
import com.balanced.recurring.enums.FrequencyGranularity;
import com.balanced.recurring.service.RecurringItemService;
...
import com.balanced.transaction.group.dto.CreateTransactionGroupInput;
import com.balanced.transaction.group.service.TransactionGroupService;
import com.balanced.transaction.service.TransactionService;
import com.balanced.transaction.split.dto.CreateTransactionSplitInput;
import com.balanced.transaction.split.dto.SplitChildInput;
import com.balanced.transaction.split.service.TransactionSplitService;
...
public class SeedDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Logger balancedLogger = (Logger) LoggerFactory.getLogger("com.balanced");
        Level previousLevel = balancedLogger.getLevel();
        balancedLogger.setLevel(Level.WARN);
        ...
        try {
            ...
            balancedLogger.setLevel(previousLevel);
        }
    ...
    private void setSeedAuthentication() {
        setAuthenticationForEmail("seed-data@balanced.dev");
    }
